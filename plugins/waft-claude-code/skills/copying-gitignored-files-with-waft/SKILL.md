...
description: Reference for waft commands, .worktreeinclude semantics, compatibility profiles, configuration, diagnostics, and Git hooks.
when_to_use: Use when copying Git-ignored local files into linked worktrees with waft, editing or checking .worktreeinclude rules, choosing waft compatibility settings, or setting up automatic copying after checkout.
